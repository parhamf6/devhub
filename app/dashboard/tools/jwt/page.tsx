...
//     } catch (err) {
//       setDecoded(null);
//       if (token.trim() !== '') setError('Invalid or malformed JWT.');
//     }
//   }, [token]);
...
//       setEncoded(jwt);
//     } catch (e) {
//       setEncoded('Error encoding token. Check your input JSON.');
//     }
//   };
...
//                 <div className="rounded-md overflow-auto text-sm font-mono border p-2 bg-muted text-muted-foreground">
//                   <JSONPretty data={decoded} />
//                 </div>
//                 {decoded?.exp && (
//                   <Badge variant={isExpired(decoded.exp) ? "destructive" : "default"}>
//                     {isExpired(decoded.exp) ? "Expired" : "Valid"} (exp: {new Date(decoded.exp * 1000).toLocaleString()})
//                   </Badge>
//                 )}
//                 {decoded?.iss && (
//                   <Badge className="ml-2">Issuer: {decoded.iss}</Badge>
//                 )}
//                 <div className="pt-2">
//                   <Button size="sm" onClick={() => handleCopy(JSON.stringify(decoded, null, 2))}>
...
//           <div>
//             <Label>Header</Label>
//             <Textarea value={header} onChange={(e) => setHeader(e.target.value)} rows={3} />
//           </div>
//           <div>
//             <Label>Payload</Label>
...
//               <RefreshCcw className="w-4 h-4 mr-2" /> Generate JWT
//             </Button>
//             {encoded && (
//               <Button variant="secondary" onClick={() => handleCopy(encoded)}>
...
//                 <Textarea value={encoded} readOnly rows={4} />
//               </CardContent>
//             </Card>
//           )}
//         </TabsContent>
