...
export const ToolCardFav: React.FC<ToolCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className="flex flex-col bg-background gap-4 border border-border rounded-[16px] justify-between p-4 w-[320px] h-[320px]
...
//     >
//       <div
//         className="flex flex-col bg-background gap-4 border border-border rounded-[32px] justify-between p-4 w-[320px] h-[320px]
//           hover:border-secondary transition-colors duration-300"
//       >
//         {/* Top row: name + category + dropdown */}
//         <div className="flex justify-between w-full items-start">
...
//         {/* Use button */}
//         <div className="bg-gradient-to-br from-primary to-muted border-2 border-border p-2 hover:scale-105 rounded-[16px] text-sm font-medium transition-transform duration-300 ">
//           <Link href={`/dashboard/tools/${slug}`} className="flex gap-2 items-center justify-center">
//             Use {name} <ChevronRight className="w-4 h-4" />
//           </Link>
//         </div>
...
// import { Button } from "@/components/ui/button";
// import { Badge } from "@/components/ui/badge";
// import { MoreHorizontal, Eye, ExternalLink, Star, ChevronRight } from "lucide-react";
// import {
//     DropdownMenu,
//     DropdownMenuContent,
//     DropdownMenuItem,
...
//     return (
//         <motion.div
//         whileHover={{ borderColor: "#eab308" }} // tailwind amber-500
//         transition={{ type: "spring", stiffness: 300, damping: 20 }}
//         >
//         <div
//             className="flex bg-background flex-col gap-2 border border-border rounded-[32px] justify-between sm:overflow-y-scroll md:overflow-y-hidden p-4 w-[280px] h-[280px]
//             hover:border-secondary transition-colors duration-300 "
//         >
//             <div className="flex justify-between w-full items-start">
//             <div className="flex gap-2 items-center">
...
//                     <h2 className="text-xl font-semibold leading-tight">{name}</h2>
//                     <div className="text-sm text-muted-foreground">
//                         <Link href={`/tools/categories/${category}`} className="hover:underline">
//                         {category}
//                         </Link>
//                         {version && <span className="ml-2">v{version}</span>}
//                     </div>
...
//             <div className="flex flex-wrap gap-1">
//             {tags.map((tag) => (
//                 <Link href={`/tools/tags/${tag}`} key={tag}>
//                 <Badge
//                     variant="secondary"
//                     className="text-xs hover:bg-accent hover:text-background transition-colors"
//                 >
...
//             <div className="text-accent border p-2 rounded-[16px] text-sm font-medium hover:bg-accent hover:text-background transition-colors duration-300 ring">
//             <Link href={`/tools/${slug}`} className="flex gap-2 items-center justify-center">
