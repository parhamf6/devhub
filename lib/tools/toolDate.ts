...
export const tools: ToolCardProps[] = [
  ...
  },
  {
    ...
    slug: "oauth-playground",
    description: "Simulate OAuth 2.0 flows with client ID/secret",
    info: "Test Authorization Code, Client Credentials, and Implicit flows. Debug token responses and scopes.",
    category: "Security",
    version: "1.0.0",
    tags: ["oauth", "authentication", "debug"],
  },
  {
    name: "CSRFG Token Generator",
    slug: "csrf-token-generator",
    description: "Generate secure CSRF tokens",
    info: "Create strong CSRF tokens for forms or API requests. Configurable length and encoding options.",
    category: "Security",
    version: "1.0.0",
    tags: ["generator", "security", "token"],
  },
  {
    name: "HMAC Generator",
    slug: "hmac-generator",
  ...
  },
  {
    ...
    description: "Names, emails, addresses, and more",
    info: "Generate realistic fake data for testing. Includes names, emails, addresses, phone numbers, and companies.",
    category: "Generator",
    version: "1.0.0",
    tags: ["test", "mock", "data"],
  },
  ...
  },
  {
    ...
    description: "Convert to/from human-readable dates",
    info: "Convert Unix timestamps to readable dates and back. Supports milliseconds and timezones.",
    category: "Converter",
    version: "1.0.0",
  ...
  },
  {
    ...
    info: "Convert numbers between binary, octal, decimal, and hexadecimal. Useful for low-level programming.",
    category: "Converter",
    version: "1.0.0",
  ...
  },
  {
    ...
    info: "Encode special characters to HTML entities or decode them back. Essential for web content.",
    category: "Converter",
    version: "1.0.0",
